					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="8%"><input type="checkbox" id="ckAll" onclick="checkAll()"/>全选/全不选</td>
							...
							<c:forEach items="${book}" var="b">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8"><input type="checkbox" name="ids" value="${b.id}"></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23">${b.id}</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="18%">${b.name}</td>
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="${pageContext.request.contextPath}/findId?id=${b.id}">
											<img
											src="${pageContext.request.contextPath}/admin/images/i_edit.gif"
											border="0" style="CURSOR: hand"> </a>
									</td>

									<td align="center" style="HEIGHT: 22px" width="7%"><a href="javascript:delBook('${b.id}','${b.name}')">
											<img
